...
extern void Configura_Reg_ADC0(void)
{
    ...
    GPIOE_AHB->AMSEL = (1<<5)|(1<<2)|(1<<1); //PE5, PE2, PE2
    ...
    ADC0->IM |= (1<<0)|(1<<1)|(1<<2); /* Unmask ADC0 sequence 2 interrupt pag 1082*/
